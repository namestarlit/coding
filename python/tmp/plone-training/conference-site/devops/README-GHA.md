...
2. Go to your repository at [namestarlit/conference-site](https://github.com/namestarlit/conference-site).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `conference-site.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | conference-site.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | conference-site.example.com |
...
- [Backend Tests Workflow](https://github.com/namestarlit/conference-site/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/namestarlit/conference-site/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/namestarlit/conference-site-backend`) and Frontend (`ghcr.io/namestarlit/conference-site-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of conference-site.example.com](https://github.com/namestarlit/conference-site/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/conference-site.example.com.yml` stack.
