...
```
DEPLOY_ENV=prod
DEPLOY_HOST=conference-site.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
DOCKER_CONFIG=.docker
STACK_NAME=conference-site-example-com
```
...
prod:
  hosts:
    conference-site.example.com:
      ansible_user: root
      host: conference-site
      hostname: conference-site.example.com
```
...
Deploy the stack defined in `devops/stacks/conference-site.example.com.yml` to the remote server with:
